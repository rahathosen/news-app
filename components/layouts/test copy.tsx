          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-stone-100 dark:bg-[#040D12] pb-12 shadow-xl">
                      ...
                      >
                        <div className="grid grid-cols-1 items-start gap-x-6 gap-y-10">
                          <div className="grid grid-cols-1 gap-x-6 gap-y-10">
                            {/* feature test area start */}
                            <Disclosure>
                              {({ open }) => (
                                <>
                                  <Disclosure.Button className="flex gap-10 w-min justify-between  font-medium px-4 py-2 text-gray-900 dark:text-gray-400 bg-gray-950  text-left text-sm focus:outline-none focus-visible:ring focus-visible:ring-gray-500 focus-visible:ring-opacity-75">
                                  ...
                                  <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500 dark:bg-gray-950">
                                    <ul
                                      role="list"
                ...
                <div className="space-y-6 border-t border-gray-200 dark:border-gray-900 px-4 py-6 ">
                  ...
                  <div className="hidden h-full lg:flex">
                    ...
                    <Popover.Group className="ml-8">
                      <div className="flex h-full justify-center space-x-8">
                              ...
                              <>
                                ...
                                >
                                  <Popover.Panel className="absolute inset-x-0 top-full text-gray-500 sm:text-sm">
                                    ...
                                    <div
                                      className="absolute inset-0 top-1/2 bg-stone-100 dark:bg-[#040D12] shadow"
                                      aria-hidden="true"
                                    />

                                    <div className="relative bg-stone-100 dark:bg-[#040D12] border-t border-stone-100 dark:border-gray-900 ">
                        ...
                        <Link
                          href="/search"
                          className="ml-2 p-[1.35rem] text-gray-400 hover:text-gray-500"
                        >
