...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "flex h-full w-full flex-col overflow-hidden rounded-md bg-white text-gray-950 dark:bg-[#071720] dark:text-gray-50",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center dark:border-[#0C2424]  border-b px-3" cmdk-input-wrapper="">
    <MagnifyingGlassIcon className="mr-2 h-4 w-4 shrink-0 opacity-50" />
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-10 w-full rounded-md bg-transparent py-3 text-sm outline-none focus:border-transparent focus:ring-transparent focus:outline-none placeholder:text-gray-500 disabled:cursor-not-allowed disabled:opacity-50  dark:placeholder:text-gray-400",
        className
      )}
      {...props}
    />
