...
export default async function CoverLeaderboardAd() {
  try {
    const adbox = await adGQL(4);
    ...
    return (
      <div className="relative my-2 flex justify-center items-center">
        <Link href="/">
          <Image
            src={
              "https://res.cloudinary.com/dfbhz3cfv/image/upload/v1700556759/mri7qfhk7lj8njeeb0ls.png"
            }
            alt={"default cover leaderboard ad"}
            width={728}
            height={90}
