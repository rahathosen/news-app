...
export default function OpnionNews({ webInfo, articles }: any) {
  return (
    <>
      <div className="bg-stone-100 dark:bg-[#040D12] mt-4  sm:mt-4 2xl:p-8 rounded-b-lg rounded-t-lg   pt-4 mb-4 pb-4">
                  ...
                  <div className="flex flex-row flex-wrap ">
                    <div className="flex-shrink max-w-full w-full sm:w-1/3 lg:w-1/4 px-2 pb-3 pt-3 sm:pt-0 border-b-[1px] sm:border-b-0 border-solid border-gray-200 dark:border-gray-900">
                      {articles.map((post: any) => (
                        ...
                        >
                          <Link href={`../article/${post.uniqueId}`}>
                            <Image
                              src={
                          ...
                          <div className="py-0 sm:py-3 pl-3 sm:pl-0">
                            <h3 className="text-lg font-bold leading-tight mb-2 text-black dark:text-gray-400">
                              <Link
                                href={`../article-category/${post.category.uniqueId}`}
                              >
